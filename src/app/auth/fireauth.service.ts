...
export class FireAuthService {
  ...
  public signInWithPhone$(phone: string): Observable<ConfirmationResult> {
    return from(signInWithPhoneNumber(this.auth, phone, new RecaptchaVerifier(this.auth, 'recaptcha', { size: 'invisible' })));
  }
  ...
  public signInWithEmailLink$(email: string, emailLink: string): Observable<UserCredential> {
