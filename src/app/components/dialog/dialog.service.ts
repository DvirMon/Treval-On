...
import { MatDialog, MAT_DIALOG_DEFAULT_OPTIONS, MatDialogConfig, MatDialogRef } from '@angular/material/dialog';
...
export class DialogService {
  ...
  // open spinner dialog
  public openDialog<T>(component: ComponentType<T>, data: unknown): MatDialogRef<T, unknown> {
